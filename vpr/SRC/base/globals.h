...
extern struct s_trace **trace_head_con;
extern struct s_trace **trace_tail_con;
extern struct s_trace **back_trace_head_con;	
extern struct s_trace **back_trace_tail_con;	
